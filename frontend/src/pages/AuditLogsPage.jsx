...
function AuditLogsPage({ initialAudits, loading: initialLoading, error: initialError, onRetry }) {
  ...
  return (
    <div className="page-section">
      <div className="section-heading rich-heading"><div><p className="panel-label">Audit Insights</p><h2>IAM activity monitoring</h2><p className="section-meta">{logs.length} events returned from the audit API.</p></div><div className="count-chip">{logs.length} events</div></div>
